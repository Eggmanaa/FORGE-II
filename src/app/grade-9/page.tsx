...
export default function Grade9Page() {
  const lessons = getLessonsByGrade(9);
  ...
  return (
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="mb-12">
          <h1 className="text-5xl font-bold text-primary mb-4">Grade 9 Curriculum</h1>
          <p className="text-2xl text-foreground/70">Emotional Awareness & Understanding</p>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-border flex justify-between">
          ...
          <Link href="/grade-10">
            <Button className="bg-primary hover:bg-primary/90">Next: Grade 10 →</Button>
          </Link>
        </div>
      </div>
    </div>
