    ...
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="container mx-auto max-w-6xl">
        <div className="mb-8 flex items-center justify-between flex-wrap gap-4">
          <Link href="/grade-9">
            <Button variant="outline">← Grade 9</Button>
          </Link>
        ...
        <div className="mb-12">
          <h1 className="text-5xl font-bold text-primary mb-4">Grade 10 Curriculum</h1>
          <p className="text-2xl text-foreground/70">Managing Anxiety & Building Empathy</p>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-border flex justify-between">
          <Link href="/grade-9">
            <Button variant="outline">← Previous: Grade 9</Button>
          </Link>
          <Link href="/grade-11">
            <Button className="bg-primary hover:bg-primary/90">Next: Grade 11 →</Button>
          </Link>
        </div>
      </div>
    </div>
